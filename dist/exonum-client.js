...
function merkleProof(rootHash, count, proofNode, range, type) {
    ...
    var rangeStart;
    try {
        rangeStart = (0, _bigInteger2.default)(range[0]);
    } catch (e) {
    ...
    var rangeEnd;
    try {
        rangeEnd = (0, _bigInteger2.default)(range[1]);
    } catch (e) {
    ...
    if (typeof actualHash === 'undefined') {
        // tree is invalid
        return undefined;
...
function Int64(value, buffer, from, to) {
    ...
    if (val === false) {
        return;
    } else if (!_bigInteger2.default.isInstance(val)) {
        return;
    }
