...
const { MapProof } = Exonum

const proto = require('./proto/protocol.js')
...
describe('MapProof', () => {
  ...
  it('verify valid wallet proof', () => {
    ...
    const walletProof = new MapProof(data, Exonum.Hash, Wallet)

    expect(walletProof.merkleRoot).to.equal('d99c4a106e2e42c1760b361bcd77719a17cf2f4a197c30296ad76d8b69945b6f')
  })
})
