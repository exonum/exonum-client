...
describe('Protobuf serialization', function () {
  it('should serialize data for transaction', function () {
    ...
    const data = {
      ...
      serialized: new Uint8Array([
        10, 77, 10, 5, 8, 130, 1, 16, 0, 18, 68, 10,
        48, 127, 159, 58, 225, 166, 250, 107, 150, 182, 215, 221,
        58, 235, 166, 248, 237, 206, 187, 233, 183, 31, 215, 150,
        181, 127, 103, 244, 239, 189, 55, 115, 150, 220, 105, 246,
        249, 239, 143, 90, 107, 189, 249, 113, 239, 27, 237, 205,
        250, 18, 12, 83, 109, 97, 114, 116, 32, 119, 97, 108,
        108, 101, 116, 24, 208, 245, 21
      ])
    }
  ...
  it('should serialize data for small transactions', function () {
    ...
    const data = {
      ...
      serialized: new Uint8Array([
        10, 17, 10, 15, 10, 5, 8, 128, 1, 16, 2, 18, 6, 10, 4, 116, 101, 115, 116, 18, 34, 10, 32, 223, 47, 77, 176, 65, 28, 55, 16, 229, 112, 233, 156, 67, 98, 18, 244, 154, 11, 122, 13, 14, 0, 143, 181, 11, 152, 117, 136, 49, 153, 78, 160, 26, 66, 10, 64, 225, 9, 251, 81, 153, 27, 172, 173, 127, 237, 111, 206, 5, 171, 232, 77, 6, 31, 85, 242, 32, 237, 194, 153, 84, 184, 54, 188, 208, 11, 212, 104, 141, 190, 106, 68, 9, 175, 19, 126, 231, 18, 154, 213, 143, 8, 198, 8, 38, 208, 79, 64, 149, 172, 213, 9, 130, 68, 101, 70, 249, 203, 199, 4
      ])
    }
  ...
  it('should serialize data for precommit', function () {
    ...
    const data = {
      ...
      serialized: [
        ...
        209, 116, 70, 82, 206, 68, 85, 10, 48, 127, 159, 58, 225, 166, 250, 107, 150, 182, 215, 221, 58,
  ...
  it('should serialize data for new transaction with zero int', function () {
    ...
    const data = {
      ...
      serialized: new Uint8Array([
        10, 75, 10, 5, 8, 130, 1, 16, 0, 18, 66, 10,
        48, 127, 159, 58, 225, 166, 250, 107, 150, 182, 215, 221,
        58, 235, 166, 248, 237, 206, 187, 233, 183, 31, 215, 150,
        181, 127, 103, 244, 239, 189, 55, 115, 150, 220, 105, 246,
        249, 239, 143, 90, 107, 189, 249, 113, 239, 27, 237, 205,
