...
describe('Examples from README.md', function() {
    ...
    it('should sign custom type', function() {
        ...
        var secretKey = '978e3321bd6331d56e5f4c2bdb95bf471e95a77a6839e68d4241e7b0932ebe2bfa7f9ee43aff70c879f80fa7fd15955c18b98c72310b09e7818310325050cf7a';
        var signature = Exonum.sign(secretKey, data, User);

        expect(signature).to.equal('c1db9a5f01ebdff27e02652a9aae5c9a4ac88787587dabceb9f471ae0b8e051b9632dfd26922f6abf24ff2d3275028fe286703d25ee7fe6b1711e89af4a7d307');
    });
    ...
    it('should verify custom type signature', function() {
        ...
        expect(Exonum.verifySignature(signature, publicKey, data, User)).to.equal(true);
    });
    ...
    it('should sign transaction', function() {
        ...
        expect(signature).to.equal('8ff692b47d17f7738ec2d19f5296d3810909a62fe1480eb752b531f8e17056f6578985090db822612f88c3bcad4f0539401836e5ad58913c489784ff3e415a0b');
    });
    ...
    it('should verify transaction signature', function() {
        ...
        expect(SendFunds.verifySignature(signature, publicKey, data)).to.equal(true);
    });
